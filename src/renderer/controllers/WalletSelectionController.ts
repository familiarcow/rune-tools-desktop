...
export class WalletSelectionController {
    ...
    private showUpdateNotification(updateInfo: any): void {
        ...
        notification.className = 'update-notification-component'
        notification.innerHTML = `
            <div class="update-notification-content">
                <div class="update-notification-info">
                    <span class="update-notification-icon">⬆️</span>
                    <div class="update-notification-text">
                        <div class="update-notification-title">Rune Tools v${updateInfo.version} Available</div>
                        <div class="update-notification-subtitle">
                            ${updateInfo.fileSize || 'Ready to download'} 
                            ${updateInfo.isVerified ? '✅ GPG Verified' : '⚠️ Could not verify release signature'}
                        </div>
                        ${!updateInfo.isVerified ? '<div class="update-notification-warning">⚠️ Could not verify release signature</div>' : ''}
                    </div>
                </div>
                <div class="update-notification-actions">
                    <button class="update-notification-btn update-notification-btn-primary" onclick="window.open('${updateInfo.downloadUrl}')">
                        Download
                    </button>
                    <button class="update-notification-btn" onclick="window.open('${updateInfo.changelogUrl}')">
                        Changelog
                    </button>
                    <button class="update-notification-btn" onclick="document.getElementById('update-notification').remove()">
                        Later
                    </button>
                </div>
            </div>
        ...
        console.log('🎉 Update notification displayed and will remain until dismissed')
    }
}